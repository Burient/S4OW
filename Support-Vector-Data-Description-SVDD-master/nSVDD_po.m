...
trainData = trainData1(randvector(1:260),:);
trainLabel1 = ones(273,1); 
trainLabel = trainLabel1(randvector(1:260),:);
testdata1 = trainData1(randvector(261:end),:);
testLabel1 = trainLabel1(randvector(261:end),:);

load('Agfa_DC-504_0.mat') 
testdata2 = fea_all;
testData = [testdata1;testdata2 ];
testLabel2 = ones(167,1)*(-1);
